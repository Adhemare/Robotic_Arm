...
int main(void)
{
  ...
  SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOG);//Habilitamos el puerto G
  ...
  while (1)
  {
    ...
    //PWMPulseWidthSet(PWM0_BASE,PWM_OUT_2,cargar);
    PWMPulseWidthSet(PWM0_BASE,PWM_OUT_2,37499*0.0274);

    //Configuramos movimiento de pinza
    //PWMPulseWidthSet(PWM0_BASE,PWM_OUT_1,37499*0.12);
    //SysCtlDelay(108000000);
    //PWMPulseWidthSet(PWM0_BASE,PWM_OUT_1,37499*0.0274);
